...
class Sam:
  def __init__(self, sam2_checkpoint, model_cfg, ann_frame_idx, threshold=0., save_visualization=False, device='cpu'):
  ...
  def get_mask_on_image(self, masks, video, obj_id=None, random_color=False, save_path=None):
